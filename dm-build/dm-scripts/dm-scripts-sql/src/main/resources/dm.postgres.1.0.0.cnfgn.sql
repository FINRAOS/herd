...
-- Staging bucket is where the various DM scripts are stored
...
SET @KmsExternalArn='';
SET @OozieWorkflowLocation='DM_SCRIPTS/emr/bootstrap/dm_oozie_wrapper/';
...
-- Name of Environment --
-------------------------
INSERT INTO cnfgn VALUES ('dm.environment', '@EnvName', NULL);
...
------------------------------
INSERT INTO cnfgn VALUES ('emr.oozie.dm.wrapper.workflow.s3.location', '@OozieWorkflowLocation', NULL);
INSERT INTO cnfgn VALUES ('emr.s3.hdfs.copy.script', '@OozieHdfsCopyScript', NULL);
INSERT INTO cnfgn VALUES ('emr.dm.support.security.group', '@OozieSecurityGroup', NULL);
...
---------------------------------
INSERT INTO cnfgn VALUES ('dm.notification.sqs.outgoing.queue.name', '@SqsOutgoingQueue', NULL);
INSERT INTO cnfgn VALUES ('dm.notification.sqs.incoming.queue.name', '@SqsIncomingQueue', NULL);
