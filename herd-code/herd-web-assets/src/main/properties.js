...
(function ()
{
    ...
    angular.module('herd').constant('properties', {
        ...
        // Assumes that there is a context root since this is a Java WAR
        // Retrieves the first path component from the current URI
