    ...
    describe('RestService', function()
    {
        ...
        describe('request()', function()
        {
            describe('when requesting a GET with a port in $location', function()
            {
                ...
                {
                    $httpBackend.expectGET('testProtocol://testHost:1234/herd-app/rest/testUrl').respond(200, 'testResponse');
                ...
                {
                    $httpBackend.expectGET('testProtocol://testHost:1234/herd-app/rest/testUrl').respond(400, 'testResponse');
            ...
            describe('when requesting a GET without a port in $location', function()
            {
                it('constructs the correct GET request to $http, and returns promise with successful response status and data', function()
                {
                    ...
                    $httpBackend.expectGET('testProtocol://testHost/herd-app/rest/testUrl').respond(200, 'testResponse');
