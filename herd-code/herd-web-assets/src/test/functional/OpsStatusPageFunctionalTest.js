...
(function ()
{
    ...
    describe('OpsStatusPageFunctionalTest', function ()
    {
        ...
        function setFilter(view, filter)
        {
            ...
            view.find('.herd-date-range-start-input').val(moment(filter.startPartitionValue).format('YYYY-MM-DD')).change();
            view.find('.herd-date-range-end-input').val(moment(filter.endPartitionValue).format('YYYY-MM-DD')).change();
        ...
        describe('DatePicker tests', function ()
        {
            ...
            {
                view.find('.herd-date-range-start-input').click();
                $scope.$digest();
            }

            function clickEndRange()
            {
                view.find('.herd-date-range-end-input').click();
                $scope.$digest();
            }

            function isStartRangePickerOpen()
            {
                return view.find('.herd-date-range-start ul.dropdown-menu').css('display') == 'block';
            }

            function isEndRangePickerOpen()
            {
                return view.find('.herd-date-range-end ul.dropdown-menu').css('display') == 'block';
            }
