...
//  ignore("getPassword should return correct password from credStash when component is null") {
//    val dataCatalog = new DataCatalog(spark, "test.com")
//
//    // Create mock credStash wrapper
//    val mockCredStash = mock[CredStashWrapper]
...
//  }
  ...
  test("dmAllObjectsInNamespace should return the business object definition keys in List format") {
    ...
    // Test the method
    val objectList = dataCatalog.getAllObjectsInNamespace(namespace)
...
//  ignore("getBusinessObjectDefinitions return should data frame containing business object definitions") {
//
...
//  ignore("getBusinessObjectFormats should return a business object formats in a data frame") {
//
...
//  ignore("queryPath should return a business object data XML") {
//
...
//  ignore("dmSearch should return a list of tuples containing business object definition name and partition value") {
//
...
//   */
//  ignore("query path from generate partitions returns list of formatted s3 prefixes") {
//
