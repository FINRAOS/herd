...
@ComponentScan(value = {"org.finra.herd.tools.uploader", "org.finra.herd.tools.downloader", "org.finra.herd.tools.retention.exporter",
    ...
    excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = {"org\\.finra\\.herd\\.tools\\.uploader\\.config\\..*",
        "org\\.finra\\.herd\\.tools\\.downloader\\.config\\..*", "org\\.finra\\.herd\\.tools\\.retention\\.exporter\\.config\\..*",
