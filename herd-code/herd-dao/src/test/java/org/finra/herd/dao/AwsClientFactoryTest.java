...
public class AwsClientFactoryTest extends AbstractDaoTest
{
    ...
    {
        assertNotNull(awsClientFactory.getAmazonSNSClient(
    ...
    {
        assertNotNull(awsClientFactory.getAmazonSQSClient(
            new AwsParamsDto(NO_AWS_ACCESS_KEY, NO_AWS_SECRET_KEY, NO_SESSION_TOKEN, HTTP_PROXY_HOST, HTTP_PROXY_PORT, AWS_REGION_NAME_US_EAST_1)));
    }
    ...
    public void testGetEc2ClientCacheHitMiss()
    {
        ...
        AmazonEC2 amazonEC2Client = awsClientFactory.getEc2Client(awsParamsDto);
