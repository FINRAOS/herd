 ...
 */
public class HerdStringHelperTest extends AbstractDaoTest
{
    @Autowired
    ...
    public void testGetRequiredConfigurationValue() throws Exception
    {
        ...
        try
        {
            String resultValue = herdStringHelper.getRequiredConfigurationValue(ConfigurationValue.ACTIVITI_JOB_DEFINITION_ID_TEMPLATE);
    ...
    public void testSplitStringWithDefaultDelimiterEscaped()
    {
        ...
        List<String> splitString = herdStringHelper.splitStringWithDefaultDelimiterEscaped(delimitedString);
    ...
    public void testSplitAndTrim()
    {
        ...
        Set<String> actualResults = herdStringHelper.splitAndTrim(", \n\t\ra \n\t\r,,b,c,", ",");
