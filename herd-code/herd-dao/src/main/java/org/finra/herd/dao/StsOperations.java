...
public interface StsOperations
{
     ...
     *
     * @param awsSecurityTokenService the client for accessing the AWS Security Token Service
     ...
     */
    AssumeRoleResult assumeRole(AWSSecurityTokenService awsSecurityTokenService, AssumeRoleRequest assumeRoleRequest);
}
