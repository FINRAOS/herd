...
public interface StorageUnitDao extends BaseJpaDao
{
     ...
     * additional sub-partition values.  Basically, method tries to find at least one sub-partition for the specified business object data that is explicitly
     * registered in the same storage.
     *
     * @param storageEntity the storage entity
     * @param businessObjectFormatEntity the business object format entity
     * @param partitionValue the business object data primary partition value
     * @param subPartitionValues the list of business object data sub-partition values, maybe null or empty
     * @param businessObjectDataVersion the business object data version
     *
     * @return the storage unit entity
     */
    StorageUnitEntity getExplicitlyRegisteredSubPartition(StorageEntity storageEntity, BusinessObjectFormatEntity businessObjectFormatEntity,
