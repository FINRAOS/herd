...
{
    // TODO: Migrate these statuses to "HERD_PREP" and "HERD_FAILED". This is a breaking change since the statuses are returned from the REST tier
    // so this may be difficult.
    /*
     * The status that will be returned, when herd wrapper workflow has not yet started to run the client workflow.
     */
    ...
    public static final String HERD_OOZIE_WRAPPER_WORKFLOW_NAME = "herd_wrapper_workflow";
    ...
    public String runOozieWorkflow(String masterIpAddress, String workflowLocation, List<Parameter> parameters) throws Exception
    {
        ...
        // Properties needed for the herd wrapper workflow.
