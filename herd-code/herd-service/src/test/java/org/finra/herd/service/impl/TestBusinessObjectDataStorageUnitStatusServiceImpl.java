...
/**
 * This is a business object data storage unit status service implementation for testing.
 */
@Service
@Transactional(value = DaoSpringModuleConfig.HERD_TRANSACTION_MANAGER_BEAN_NAME)
@Primary
public class TestBusinessObjectDataStorageUnitStatusServiceImpl extends BusinessObjectDataStorageUnitStatusServiceImpl
{
    /**
     * {@inheritDoc}
     * <p/>
