...
/**
 * Test suite for Get Business Object Data Attributes Activiti wrapper.
 */
public class GetBusinessObjectDataAttributesTest extends HerdActivitiServiceTaskTest
{
    ...
    public void testGetBusinessObjectDataAttribute() throws Exception
    {
        ...
        for (Attribute attribute : testAttributes)
        {
            expectedBusinessObjectDataAttributeKeys.getBusinessObjectDataAttributeKeys()
                .add(businessObjectDataAttributeHelper.getBusinessObjectDataAttributeKey(businessObjectDataKey, attribute.getName()));
        }
    ...
    public void testGetBusinessObjectDataAttributeMissingRequiredParameter() throws Exception
    {
        ...
        executeWithoutLogging(ActivitiRuntimeHelper.class, () -> {
            testActivitiServiceTaskFailure(GetBusinessObjectDataAttributes.class.getCanonicalName(), fieldExtensionList, parameters, variableValuesToValidate);
        });
    }
