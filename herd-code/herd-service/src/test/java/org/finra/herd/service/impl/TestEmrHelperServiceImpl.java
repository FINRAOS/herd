...
public class TestEmrHelperServiceImpl extends EmrHelperServiceImpl
{
    ...
    {
        return emrCreateClusterAwsSpecificStepsImpl(request, emrClusterDefinition, emrClusterAlternateKeyDto, emrParamsDto);
    }
     ...
     */
    @Override
    public EmrClusterPreCreateDto emrPreCreateClusterSteps(EmrClusterAlternateKeyDto emrClusterAlternateKeyDto, EmrClusterCreateRequest request)
        throws Exception
    {
