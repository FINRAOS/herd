...
public class UploadDownloadAsyncServiceTest extends AbstractServiceTest
{
    ...
    @Autowired
    private org.finra.herd.service.UploadDownloadAsyncService UploadDownloadAsyncService;
    ...
    public void testPerformFileMoveSync() throws Exception
    {
        ...
        String[] statusUpdates = uploadDownloadHelperService.performFileMoveSync(herdDaoHelper.getBusinessObjectDataKey(sourceBusinessObjectDataEntity),
                herdDaoHelper.getBusinessObjectDataKey(targetBusinessObjectDataEntity), "", "", "FILE_NAME", MockS3OperationsImpl.MOCK_KMS_ID,
                emrHelper.getAwsParamsDto());

        // Refresh the data entities
        sourceBusinessObjectDataEntity = herdDaoHelper.getBusinessObjectDataEntity(herdDaoHelper.getBusinessObjectDataKey(sourceBusinessObjectDataEntity));
        targetBusinessObjectDataEntity = herdDaoHelper.getBusinessObjectDataEntity(herdDaoHelper.getBusinessObjectDataKey(targetBusinessObjectDataEntity));
    ...
    public void testPerformFileMoveSyncError() throws Exception
    {
        ...
        String[] statusUpdates = uploadDownloadHelperService.performFileMoveSync(herdDaoHelper.getBusinessObjectDataKey(sourceBusinessObjectDataEntity),
                herdDaoHelper.getBusinessObjectDataKey(targetBusinessObjectDataEntity), "", "", MockS3OperationsImpl.MOCK_S3_FILE_NAME_NOT_FOUND,
    ...
    public void testPerformFileMoveASync() throws Exception
    {
        ...
        Future<Void> future = UploadDownloadAsyncService.performFileMoveAsync(herdDaoHelper.getBusinessObjectDataKey(sourceBusinessObjectDataEntity),
                herdDaoHelper.getBusinessObjectDataKey(targetBusinessObjectDataEntity), "", "", "FILE_NAME", MockS3OperationsImpl.MOCK_KMS_ID,
                emrHelper.getAwsParamsDto());
    ...
    public void testUploadDownloadHelperServiceMethodsAsync() throws Exception
    {
        ...
        uploadDownloadAsyncServiceImpl.performFileMoveAsync(herdDaoHelper.getBusinessObjectDataKey(sourceBusinessObjectDataEntity),
            herdDaoHelper.getBusinessObjectDataKey(targetBusinessObjectDataEntity), "", "", "FILE_NAME", MockS3OperationsImpl.MOCK_KMS_ID,
            emrHelper.getAwsParamsDto());
    }
}
