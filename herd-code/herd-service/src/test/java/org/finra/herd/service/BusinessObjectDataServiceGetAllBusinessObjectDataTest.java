...
public class BusinessObjectDataServiceGetAllBusinessObjectDataTest extends AbstractServiceTest
{
    ...
    public void testGetAllBusinessObjectDataByBusinessObjectDefinition()
    {
        ...
        when(businessObjectDataDao.getBusinessObjectDataByBusinessObjectDefinition(businessObjectDefinitionEntity, true, MAX_RESULTS_1))
        ...
        verify(businessObjectDataDao).getBusinessObjectDataByBusinessObjectDefinition(businessObjectDefinitionEntity, true, MAX_RESULTS_1);
    ...
    public void testGetAllBusinessObjectDataByBusinessObjectFormat()
    {
        ...
        BusinessObjectFormatEntity businessObjectFormatEntity = businessObjectFormatDaoTestHelper
            .createBusinessObjectFormatEntity(businessObjectFormatKey, FORMAT_DESCRIPTION, FORMAT_DOCUMENT_SCHEMA, FORMAT_DOCUMENT_SCHEMA_URL,
