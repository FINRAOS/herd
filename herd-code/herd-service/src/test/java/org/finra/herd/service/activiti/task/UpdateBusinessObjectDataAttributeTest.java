...
/**
 * Test suite for Update Business Object Data Attribute Activiti wrapper.
 */
public class UpdateBusinessObjectDataAttributeTest extends HerdActivitiServiceTaskTest
{
    @Test
    public void testUpdateBusinessObjectDataAttribute() throws Exception
    {
        ...
        parameters.add(buildParameter("businessObjectDataAttributeValue", ATTRIBUTE_VALUE_2));
        ...
        BusinessObjectDataAttribute expectedBusinessObjectDataAttribute = new BusinessObjectDataAttribute(businessObjectDataAttributeEntity.getId(),
            businessObjectDataAttributeHelper.getBusinessObjectDataAttributeKey(businessObjectDataKey, ATTRIBUTE_NAME_1_MIXED_CASE), ATTRIBUTE_VALUE_2);

        // Run the activiti task and validate the returned response object.
        Map<String, Object> variableValuesToValidate = new HashMap<>();
        variableValuesToValidate.put(UpdateBusinessObjectDataAttribute.VARIABLE_JSON_RESPONSE, jsonHelper.objectToJson(expectedBusinessObjectDataAttribute));
        testActivitiServiceTaskSuccess(UpdateBusinessObjectDataAttribute.class.getCanonicalName(), fieldExtensionList, parameters, variableValuesToValidate);
    }
     ...
     */
    @Test
    public void testUpdateBusinessObjectDataAttributeMissingRequiredParameter() throws Exception
    {
        ...
        executeWithoutLogging(ActivitiRuntimeHelper.class, () -> {
            testActivitiServiceTaskFailure(UpdateBusinessObjectDataAttribute.class.getCanonicalName(), fieldExtensionList, parameters,
                variableValuesToValidate);
        });
    }

    @Test
    public void testUpdateBusinessObjectDataAttributeMissingOptionalParameters() throws Exception
    {
        ...
        // Build the expected response object.
        BusinessObjectDataAttribute expectedBusinessObjectDataAttribute = new BusinessObjectDataAttribute(businessObjectDataAttributeEntity.getId(),
            businessObjectDataAttributeHelper.getBusinessObjectDataAttributeKey(businessObjectDataKey, ATTRIBUTE_NAME_1_MIXED_CASE), null);
    ...
    @Test
    public void testUpdateBusinessObjectDataAttributeMissingOptionalParametersSubPartitionValuesAsEmptyString() throws Exception
    {
        // Create a business object data key without sub-partition values.
        BusinessObjectDataKey businessObjectDataKey =
            new BusinessObjectDataKey(BDEF_NAMESPACE, BDEF_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, FORMAT_VERSION, PARTITION_VALUE,
     ...
     */
    @Test
    public void testUpdateBusinessObjectDataAttributeInvalidBusinessObjectFormatVersion() throws Exception
    {
     ...
     */
    @Test
    public void testUpdateBusinessObjectDataAttributeInvalidBusinessObjectDataVersion() throws Exception
    {
