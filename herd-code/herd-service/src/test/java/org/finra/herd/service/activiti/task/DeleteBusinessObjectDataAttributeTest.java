...
/**
 * Test suite for Delete Business Object Data Attribute Activiti wrapper.
 */
public class DeleteBusinessObjectDataAttributeTest extends HerdActivitiServiceTaskTest
{
    @Test
    public void testDeleteBusinessObjectDataAttribute() throws Exception
    {
        ...
        BusinessObjectDataAttribute expectedBusinessObjectDataAttribute =
            new BusinessObjectDataAttribute(businessObjectDataAttributeEntity.getId(), businessObjectDataAttributeKey, ATTRIBUTE_VALUE_1);
    ...
    public void testDeleteBusinessObjectDataAttributeMissingRequiredParameter() throws Exception
    {
        ...
        executeWithoutLogging(ActivitiRuntimeHelper.class, () -> {
            testActivitiServiceTaskFailure(DeleteBusinessObjectDataAttribute.class.getCanonicalName(), fieldExtensionList, parameters,
