...
public class GetBusinessObjectData extends BaseJavaDelegate
{
    ...
    public void executeImpl(DelegateExecution execution) throws Exception
    {
        ...
        Boolean excludeBusinessObjectDataStorageFiles = activitiHelper
            .getExpressionVariableAsBoolean(this.excludeBusinessObjectDataStorageFiles, execution, "excludeBusinessObjectDataStorageFiles", false, false);
