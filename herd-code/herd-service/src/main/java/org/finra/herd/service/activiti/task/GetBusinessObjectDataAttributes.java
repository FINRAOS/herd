 ...
 */
@Component
public class GetBusinessObjectDataAttributes extends BaseJavaDelegate
{
    ...
    public void executeImpl(DelegateExecution execution) throws Exception
    {
        ...
        BusinessObjectDataAttributeKeys businessObjectDataAttributeKeys =
            businessObjectDataAttributeService.getBusinessObjectDataAttributes(businessObjectDataKey);
