...
/**
 * A helper class for security function related code.
 */
@Component
public class SecurityFunctionHelper
{
    @Autowired
     ...
     */
    public void validateAndTrimSecurityFunctionKey(SecurityFunctionKey securityFunctionKey)
    {
