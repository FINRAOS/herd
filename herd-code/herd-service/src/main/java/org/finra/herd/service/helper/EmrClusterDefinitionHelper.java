...
public class EmrClusterDefinitionHelper
{
    ...
    public void validateEmrClusterDefinitionConfiguration(EmrClusterDefinition emrClusterDefinition) throws IllegalArgumentException
    {
        ...
        // Make sure instance fleet minimum ip available filter is not negative
        if (emrClusterDefinition.getInstanceFleetMinimumIpAvailableFilter() != null)
        {
            Assert.isTrue(emrClusterDefinition.getInstanceFleetMinimumIpAvailableFilter() >= 0, "Minimum number of available IPs required for the instance fleet cannot be negative");
        }
