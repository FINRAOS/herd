...
public class EmrServiceImpl implements EmrService
{
    ...
    private void setEmrClusterStatus(EmrCluster cl, ClusterStatus amazonClusterStatus) {
        ...
        cl.setStatusChangeReason(new StatusChangeReason(amazonClusterStatus.getStateChangeReason().getCode(), amazonClusterStatus.getStateChangeReason().getMessage() ));
        cl.setStatusTimeline(new StatusTimeline(toXmlGregorianCalendar(amazonClusterStatus.getTimeline().getCreationDateTime()), toXmlGregorianCalendar(amazonClusterStatus.getTimeline().getReadyDateTime()), toXmlGregorianCalendar(amazonClusterStatus.getTimeline().getEndDateTime())));
    }
}
