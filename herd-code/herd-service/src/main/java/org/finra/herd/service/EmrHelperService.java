...
public interface EmrHelperService
{
     ...
     *
     * @return the EMR cluster pre-create DTO with cluster definition and AWS related parameters
     *
     * @throws Exception Exception when the original EMR cluster definition XML is malformed
     */
    EmrClusterPreCreateDto emrPreCreateClusterSteps(EmrClusterAlternateKeyDto emrClusterAlternateKeyDto, EmrClusterCreateRequest request) throws Exception;
     ...
     * @param emrClusterAlternateKeyDto the ERM cluster alternate key
     * @param emrParamsDto the AWS related parameters
     *
