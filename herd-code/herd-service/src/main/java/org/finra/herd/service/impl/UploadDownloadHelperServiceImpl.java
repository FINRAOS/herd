...
public class UploadDownloadHelperServiceImpl implements UploadDownloadHelperService
{
        ...
        String sourceBucketName, String targetBucketName, String filePath, String kmsKeyId, AwsParamsDto awsParams)
    {
        ...
        catch (Exception e)
        {
            ...
            LOGGER.error(String.format("Failed to copy the upload single file: \"%s\" from source bucket name: \"%s\" to target bucket name: \"%s\" " +
                ...
                herdHelper.businessObjectDataKeyToString(sourceBusinessObjectDataKey), herdHelper.businessObjectDataKeyToString(targetBusinessObjectDataKey)),
                e);
        }
        ...
        try
        {
            ...
            BusinessObjectDataEntity businessObjectDataEntity = herdDaoHelper.getBusinessObjectDataEntity(targetBusinessObjectDataKey);
        ...
        catch (Exception e)
        {
            ...
            LOGGER.error(String.format(
                ...
                targetStatus, filePath, herdHelper.businessObjectDataKeyToString(targetBusinessObjectDataKey)), e);
        ...
        catch (Exception e)
        {
            ...
            LOGGER.error(String
                .format("Failed to delete the upload single file: \"%s\" from source bucket name: \"%s\" " + "for source business object data %s.", filePath,
                    sourceBucketName, herdHelper.businessObjectDataKeyToString(sourceBusinessObjectDataKey)), e);
        }
        ...
        try
        {
            ...
            businessObjectDataHelper.updateBusinessObjectDataStatus(herdDaoHelper.getBusinessObjectDataEntity(sourceBusinessObjectDataKey), sourceStatus);
        }
        catch (Exception e)
        {
            // Log the error.
            LOGGER.error(String.format(
                ...
                filePath, herdHelper.businessObjectDataKeyToString(sourceBusinessObjectDataKey)), e);
    ...
    {
        businessObjectDataHelper.updateBusinessObjectDataStatus(herdDaoHelper.getBusinessObjectDataEntity(businessObjectDataKey), businessObjectDataStatus);
    }
}
