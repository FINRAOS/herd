...
public class BusinessObjectDataRestControllerRetryStoragePolicyTransitionTest extends AbstractRestTest
{
    ...
    public void testRetryStoragePolicyTransition()
    {
        ...
        BusinessObjectData businessObjectData = businessObjectDataRestController
            .retryStoragePolicyTransition(BDEF_NAMESPACE, BDEF_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, FORMAT_VERSION, PARTITION_VALUE, DATA_VERSION,
                getDelimitedFieldValues(SUBPARTITION_VALUES), new BusinessObjectDataRetryStoragePolicyTransitionRequest(storagePolicyKey));
    ...
    public void testRetryStoragePolicyTransitionMissingOptionalParameters()
    {
        ...
        // Retry a storage policy transition for a business object data without sub-partition values.
        BusinessObjectData businessObjectData = businessObjectDataRestController
            .retryStoragePolicyTransition(BDEF_NAMESPACE, BDEF_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, FORMAT_VERSION, PARTITION_VALUE, DATA_VERSION,
                null, new BusinessObjectDataRetryStoragePolicyTransitionRequest(storagePolicyKey));
