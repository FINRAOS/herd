...
public class StoragePlatformRestControllerTest extends AbstractRestTest
{
    ...
    {
        StoragePlatforms storagePlatforms = storagePlatformRestController.getStoragePlatforms();
    ...
    {
        StoragePlatform storagePlatform = storagePlatformRestController.getStoragePlatform(StoragePlatformEntity.S3);
    ...
    {
        storagePlatformRestController.getStoragePlatform("invalid" + getRandomSuffix());
    }
}
