...
public class RelationalTableRegistrationRestController extends HerdBaseController
{
    ...
    /**
     * Delete a relational table registration.
     *
     ...
     * @return business object data
     */
    @RequestMapping(value = "/relationalTableRegistrations/namespaces/{namespace}/businessObjectDefinitionNames/{businessObjectDefinitionName}" +
        "/businessObjectFormatUsages/{businessObjectFormatUsage}", method = RequestMethod.DELETE)
    @Secured(SecurityFunctions.FN_RELATIONAL_TABLE_REGISTRATIONS_DELETE)
    public RelationalTableRegistrationDeleteResponse deleteRelationalTableRegistration(@PathVariable("namespace") String namespace,
