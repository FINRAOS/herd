...
public class DataBridgeEnvTestSpringModuleConfig
{
     ...
     */
    public static final String TEST_LOG4J_CONFIG_RESOURCE_LOCATION = "classpath:dm-log4j-test.xml";
    ...
    @Bean
    public DmCharacterEscapeHandler dmCharacterEscapeHandler()
    {
        return new DmCharacterEscapeHandler();
    }
