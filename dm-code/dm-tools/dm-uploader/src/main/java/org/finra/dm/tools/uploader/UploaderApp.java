...
public class UploaderApp extends DataBridgeApp
{
    ...
    public UploaderApp()
    {
        argParser = new ArgumentParser("dm-uploader-app");
    ...
    public ReturnValue go(String[] args) throws Exception
    {
        ...
        controller.performUpload(dmRegServerAccessParamsDto, argParser.getFileValue(manifestPathOpt), params, argParser.getBooleanValue(createNewVersionOpt),
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        {
            LOGGER.error("Error running Data Management Uploader.", e);
