...
(function()
{
    ...
    describe('DateRangeDirective', function()
    {
        ...
        describe('given some default parameters', function()
        {
            ...
            {
                return view.find('.dm-date-range-start-input');
            }

            function getEndInput()
            {
                return view.find('.dm-date-range-end-input');
            }
            ...
            beforeEach(function()
            {
                ...
                var template = '<dm-date-range model="vm.testModel" change="vm.testOnChange()"></dm-date-range>';
