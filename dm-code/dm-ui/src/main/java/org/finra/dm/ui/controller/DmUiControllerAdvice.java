 ...
 */
@ControllerAdvice("org.finra.dm.ui.controller") // Only handle UI exceptions and not REST exceptions in a different base package.
public class DmUiControllerAdvice
{
    private static final Logger LOGGER = Logger.getLogger(DmUiControllerAdvice.class);
