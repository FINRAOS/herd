...
import org.finra.dm.ui.controller.DmUiControllerAdvice;
import org.finra.dm.ui.controller.UserException;

/**
 * Test the DM Controller Advice.
 */
public class DmControllerAdviceTest extends AbstractUiTest
{
    @Autowired
    private DmUiControllerAdvice controllerAdvice;
    ...
    {
        executeWithoutLogging(DmUiControllerAdvice.class, new Command()
        {
            @Override
            public void execute()
            {
