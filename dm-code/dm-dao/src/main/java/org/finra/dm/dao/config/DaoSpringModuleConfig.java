...
import org.finra.dm.dao.CacheKeyGenerator;
import org.finra.dm.dao.ReloadablePropertySource;
...
@ComponentScan(value = "org.finra.dm.dao", excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = "org\\.finra\\.dm\\.dao\\.config\\..*"))
...
public class DaoSpringModuleConfig implements CachingConfigurer
{
    ...
    /**
     * The DM data source bean name.
     */
    public static final String DM_DATA_SOURCE_BEAN_NAME = "dmDataSource";
    ...
    /**
     * The DM transaction manager bean name.
     */
    public static final String DM_TRANSACTION_MANAGER_BEAN_NAME = "dmTransactionManager";

    /**
     * Model packages to scan by entity manager.
     */
    public static final String MODEL_PACKAGES_TO_SCAN = "org.finra.dm.model.jpa";

    /**
     * The DM cache name.
     */
    public static final String DM_CACHE_NAME = "dm_cache";
    ...
    {
        return new DatabaseConfiguration(getDmDataSource(), ConfigurationEntity.TABLE_NAME, ConfigurationEntity.COLUMN_KEY, ConfigurationEntity.COLUMN_VALUE);
    }
     ...
     */
    public static DataSource getDmDataSource()
    {
        return (DataSource) ApplicationContextHolder.getApplicationContext().getBean(DM_DATA_SOURCE_BEAN_NAME);
    }
    ...
    public net.sf.ehcache.CacheManager ehCacheManager()
    {
        ...
        cacheConfiguration.setName(DM_CACHE_NAME);
        cacheConfiguration.setTimeToLiveSeconds(configurationHelper.getProperty(ConfigurationValue.DM_CACHE_TIME_TO_LIVE_SECONDS, Long.class));
        cacheConfiguration.setTimeToIdleSeconds(configurationHelper.getProperty(ConfigurationValue.DM_CACHE_TIME_TO_IDLE_SECONDS, Long.class));
        cacheConfiguration.setMaxElementsInMemory(configurationHelper.getProperty(ConfigurationValue.DM_CACHE_MAX_ELEMENTS_IN_MEMORY, Integer.class));
        cacheConfiguration.setMemoryStoreEvictionPolicy(configurationHelper.getProperty(ConfigurationValue.DM_CACHE_MEMORY_STORE_EVICTION_POLICY));
