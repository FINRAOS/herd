...
public class AwsSqsExceptionRetryAdvice extends AwsExceptionRetryAdvice
{
    ...
    {
        return dmStringHelper.getConfigurationValueAsInteger(ConfigurationValue.AWS_SQS_EXCEPTION_MAX_RETRY_DURATION_SECS);
    }

    @Override
    protected String getExceptionErrorCodes()
    {
        return dmStringHelper.getConfigurationValueAsString(ConfigurationValue.AWS_SQS_RETRY_ON_ERROR_CODES);
    }
}
