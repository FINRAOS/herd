...
public class DaoAopSpringModuleConfig
{
     ...
     */
    @Pointcut("execution(* org.finra.dm.dao.S3Operations.*(..))")
     ...
     */
    @Pointcut("execution(* org.finra.dm.dao.EmrOperations.*(..))")
     ...
     */
    @Pointcut("execution(* org.finra.dm.dao.Ec2Operations.*(..))")
     ...
     */
    @Pointcut("execution(* org.finra.dm.dao.StsOperations.*(..))")
     ...
     */
    @Pointcut("execution(* org.finra.dm.dao.SqsOperations.*(..))")
