...
public class BaseJpaDaoImplTest extends AbstractDaoTest
{
    ...
    @Autowired
    protected BaseJpaDaoImpl dmDaoImpl;
    ...
    public void testGetPredicateForInClauseOneChunk()
    {
        ...
        Predicate predicate =
            dmDaoImpl.getPredicateForInClause(builder, businessObjectDataEntity.get(BusinessObjectDataEntity_.partitionValue), getPartitionValueList(1000));
    ...
    public void testGetPredicateForInClauseTwoChunks()
    {
        ...
        Predicate predicate =
            dmDaoImpl.getPredicateForInClause(builder, businessObjectDataEntity.get(BusinessObjectDataEntity_.partitionValue), getPartitionValueList(1001));
