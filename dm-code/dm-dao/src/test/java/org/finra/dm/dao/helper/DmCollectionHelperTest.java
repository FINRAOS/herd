...
public class DmCollectionHelperTest extends AbstractDaoTest
{
    @Test
    public void testSafeGetNotNullElement()
    {
        String result = dmCollectionHelper.safeGet(Arrays.asList("A", "B", "C"), 2);
    ...
    {
        String result = dmCollectionHelper.safeGet(null, 2);
    ...
    {
        String result = dmCollectionHelper.safeGet(Arrays.asList("A", "B", "C"), 3);
        Assert.assertNull("result is not null", result);
    }
}
