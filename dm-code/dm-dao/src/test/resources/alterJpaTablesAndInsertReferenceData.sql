...
insert into STRGE_ATRBT (STRGE_ATRBT_ID, STRGE_CD, ATRBT_NM, ATRBT_VALUE_TX, CREAT_TS, CREAT_USER_ID, UPDT_TS, UPDT_USER_ID) values (1, 'S3_MANAGED', 'bucket.name', 'TEST-S3-MANAGED-BUCKET', DATE '2015-01-01', 'SYSTEM', DATE '2015-01-01', 'SYSTEM');
insert into STRGE_ATRBT (STRGE_ATRBT_ID, STRGE_CD, ATRBT_NM, ATRBT_VALUE_TX, CREAT_TS, CREAT_USER_ID, UPDT_TS, UPDT_USER_ID) values (2, 'S3_MANAGED_LOADING_DOCK', 'bucket.name', 'TEST-S3-MANAGED-LOADING-DOCK-BUCKET', DATE '2015-01-01', 'SYSTEM', DATE '2015-01-01', 'SYSTEM');
insert into STRGE_ATRBT (STRGE_ATRBT_ID, STRGE_CD, ATRBT_NM, ATRBT_VALUE_TX, CREAT_TS, CREAT_USER_ID, UPDT_TS, UPDT_USER_ID) values (3, 'S3_MANAGED_EXTERNAL', 'bucket.name', 'TEST-S3-MANAGED-EXTERNAL-BUCKET', DATE '2015-01-01', 'SYSTEM', DATE '2015-01-01', 'SYSTEM');
insert into STRGE_ATRBT (STRGE_ATRBT_ID, STRGE_CD, ATRBT_NM, ATRBT_VALUE_TX, CREAT_TS, CREAT_USER_ID, UPDT_TS, UPDT_USER_ID) values (4, 'S3_MANAGED', 'validate.path.prefix', 'true', DATE '2015-01-01', 'SYSTEM', DATE '2015-01-01', 'SYSTEM');
insert into STRGE_ATRBT (STRGE_ATRBT_ID, STRGE_CD, ATRBT_NM, ATRBT_VALUE_TX, CREAT_TS, CREAT_USER_ID, UPDT_TS, UPDT_USER_ID) values (5, 'S3_MANAGED', 'validate.file.existence', 'true', DATE '2015-01-01', 'SYSTEM', DATE '2015-01-01', 'SYSTEM');
