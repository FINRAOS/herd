...
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.incoming.queue.name', 'DM_INCOMING_QUEUE');
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.outgoing.queue.name', 'DM_OUTGOING_QUEUE');
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.environment', 'TEST');
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.environment', 'Development');
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.enabled', 'true');

insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.sys.monitor.request.xpath.properties', 'incoming_message_correlation_id=/monitor/header/correlation-id
incoming_message_context_message_type=/monitor/payload/contextMessageTypeToPublish
');

insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.sys.monitor.response.velocity.template', '<?xml version="1.1" encoding="UTF-8"?>
<datamgt:monitor xmlns:datamgt="http://testDomain/system-monitor">
   <header>
      <producer>
         <name>testDomain/datamanagement</name>
         <environment>$dm_notification_sqs_environment</environment>
      </producer>
      <creation>
...
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('dm.notification.sqs.business.object.data.status.change.velocity.template', '<?xml version="1.1" encoding="UTF-8"?>
<datamgt:DataManagementEvent xmlns:datamgt="http://testDomain/datamanagement/datamanagement-event">
   <header>
      <producer>
         <name>testDomain/datamanagement</name>
         <environment>$dm_notification_sqs_environment</environment>
      ...
      <context-message-type>testDomain/datamanagement/BusinessObjectDataStatusChanged</context-message-type>
      <system-message-type>NoError</system-message-type>
      <xsd>http://testDomain/datamanagement/datamanagement-event.xsd</xsd>
      <event-id>
         <system-name>testDomain/datamanagement</system-name>
...
insert into CNFGN (CNFGN_KEY_NM, CNFGN_VALUE_DS) values ('emr.oozie.dm.wrapper.workflow.s3.location', 'DM_SCRIPTS/emr/bootstrap/dm_oozie_wrapper/');