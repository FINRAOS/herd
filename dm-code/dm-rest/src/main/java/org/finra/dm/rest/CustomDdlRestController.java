...
public class CustomDdlRestController extends DmBaseController
{
    ...
    /**
     * Gets an existing custom DDL for a legacy business object format.
     *
     ...
     */
    @RequestMapping(value = CUSTOM_DDLS_URI_PREFIX + "/businessObjectDefinitionNames/{businessObjectDefinitionName}" +
    ...
    public CustomDdl getCustomDdl(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        ...
        @PathVariable("businessObjectFormatVersion") Integer businessObjectFormatVersion, @PathVariable("customDdlName") String customDdlName)
    {
        return customDdlService.getCustomDdl(
            new CustomDdlKey(null, businessObjectDefinitionName, businessObjectFormatUsage, businessObjectFormatFileType, businessObjectFormatVersion,
                customDdlName));
    }
    ...
    /**
     * Updates an existing custom DDL for a legacy business object format.
     *
     * @param businessObjectDefinitionName the business object definition name
     * @param businessObjectFormatUsage the business object format usage
     * @param businessObjectFormatFileType the business object format file type
    ...
    public CustomDdl updateCustomDdl(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        @PathVariable("businessObjectFormatUsage") String businessObjectFormatUsage,
        @PathVariable("businessObjectFormatFileType") String businessObjectFormatFileType,
        @PathVariable("businessObjectFormatVersion") Integer businessObjectFormatVersion, @PathVariable("customDdlName") String customDdlName,
    ...
    /**
     * Deletes an existing custom DDL for a legacy business object format.
     *
     * @param businessObjectDefinitionName the business object definition name
     * @param businessObjectFormatUsage the business object format usage
     * @param businessObjectFormatFileType the business object format file type
    ...
    public CustomDdl deleteCustomDdl(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        @PathVariable("businessObjectFormatUsage") String businessObjectFormatUsage,
        @PathVariable("businessObjectFormatFileType") String businessObjectFormatFileType,
        @PathVariable("businessObjectFormatVersion") Integer businessObjectFormatVersion, @PathVariable("customDdlName") String customDdlName)
    {
    ...
    /**
     * Gets a list of keys for all existing custom DDLs for a specific legacy business object format.
     *
     * @param businessObjectDefinitionName the business object definition name
     * @param businessObjectFormatUsage the business object format usage
     * @param businessObjectFormatFileType the business object format file type
    ...
    public CustomDdlKeys getCustomDdls(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        @PathVariable("businessObjectFormatUsage") String businessObjectFormatUsage,
        @PathVariable("businessObjectFormatFileType") String businessObjectFormatFileType,
