...
public class BusinessObjectFormatRestController extends DmBaseController
{
    @Autowired
     ...
     */
    @RequestMapping(
        value = "/businessObjectFormats/businessObjectDefinitionNames/{businessObjectDefinitionName}/businessObjectFormatUsages/{businessObjectFormatUsage}" +
    ...
    public BusinessObjectFormat updateBusinessObjectFormat(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        ...
        @PathVariable("businessObjectFormatVersion") Integer businessObjectFormatVersion, @RequestBody BusinessObjectFormatUpdateRequest request)
    {
        BusinessObjectFormatKey businessObjectFormatKey =
            new BusinessObjectFormatKey(null, businessObjectDefinitionName, businessObjectFormatUsage, businessObjectFormatFileType,
    ...
    @RequestMapping(
        value = "/businessObjectFormats/businessObjectDefinitionNames/{businessObjectDefinitionName}/businessObjectFormatUsages/{businessObjectFormatUsage}" +
            "/businessObjectFormatFileTypes/{businessObjectFormatFileType}", method = RequestMethod.GET)
    @Secured(SecurityFunctions.FN_BUSINESS_OBJECT_FORMATS_GET)
    public BusinessObjectFormat getBusinessObjectFormat(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        @PathVariable("businessObjectFormatUsage") String businessObjectFormatUsage,
        @PathVariable("businessObjectFormatFileType") String businessObjectFormatFileType,
    ...
    public BusinessObjectFormat deleteBusinessObjectFormat(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName,
        @PathVariable("businessObjectFormatUsage") String businessObjectFormatUsage,
        @PathVariable("businessObjectFormatFileType") String businessObjectFormatFileType,
     ...
     */
    @RequestMapping(value = "/businessObjectFormats/businessObjectDefinitionNames/{businessObjectDefinitionName}", method = RequestMethod.GET)
    @Secured(SecurityFunctions.FN_BUSINESS_OBJECT_FORMATS_ALL_GET)
    public BusinessObjectFormatKeys getBusinessObjectFormats(@PathVariable("businessObjectDefinitionName") String businessObjectDefinitionName)
    {
        return businessObjectFormatService.getBusinessObjectFormats(new BusinessObjectDefinitionKey(null, businessObjectDefinitionName), false);
    }
