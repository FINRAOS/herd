...
public class BusinessObjectFormatRestControllerTest extends AbstractRestTest
{
    ...
    {
        // Create relative database entities including a legacy business object definition.
        createTestDatabaseEntitiesForBusinessObjectFormatTesting(NAMESPACE_CD, DATA_PROVIDER_NAME, BOD_NAME, FORMAT_FILE_TYPE_CODE, PARTITION_KEY_GROUP, true);

        // Perform a create without specifying optional parameters.
        BusinessObjectFormatCreateRequest request =
            createBusinessObjectFormatCreateRequest(BLANK_TEXT, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, PARTITION_KEY, "",
                getTestAttributeDefinitions(), getTestSchema());
    ...
    public void testCreateBusinessObjectFormatUpperCaseParameters()
    {
        ...
        createTestDatabaseEntitiesForBusinessObjectFormatTesting(NAMESPACE_CD.toLowerCase(), DATA_PROVIDER_NAME.toLowerCase(), BOD_NAME.toLowerCase(),
            FORMAT_FILE_TYPE_CODE.toLowerCase(), PARTITION_KEY_GROUP.toLowerCase(), null);
    ...
    public void testCreateBusinessObjectFormatLowerCaseParameters()
    {
        ...
        createTestDatabaseEntitiesForBusinessObjectFormatTesting(NAMESPACE_CD.toUpperCase(), DATA_PROVIDER_NAME.toUpperCase(), BOD_NAME.toUpperCase(),
            FORMAT_FILE_TYPE_CODE.toUpperCase(), PARTITION_KEY_GROUP.toUpperCase(), null);
    ...
    public void testCreateBusinessObjectFormatCreateSecondVersion()
    {
        ...
        // format versions with the latestVersion flag set to Yes produces exception in dmDao.getBusinessObjectFormatByAltKey() method.
    ...
    public void testUpdateBusinessObjectFormatLegacy()
    {
        ...
        BusinessObjectFormatUpdateRequest request = createBusinessObjectFormatUpdateRequest(FORMAT_DESCRIPTION_2, getTestSchema2());
        BusinessObjectFormat updatedBusinessObjectFormat =
            businessObjectFormatRestController.updateBusinessObjectFormat(BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION, request);
    ...
    public void testUpdateBusinessObjectFormatMissingRequiredParameter()
    {
        ...
        try
        {
            businessObjectFormatRestController
                .updateBusinessObjectFormat(BLANK_TEXT, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION, request);
    ...
    public void testUpdateBusinessObjectFormatMissingOptionalParameters()
    {
        ...
        BusinessObjectFormat updatedBusinessObjectFormat = businessObjectFormatRestController
            .updateBusinessObjectFormat(BLANK_TEXT, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION, request);
    ...
    public void testUpdateBusinessObjectFormatInvalidParameters()
    {
        ...
        // Try to perform a get using invalid business object definition name and without passing a namespace code.
        try
        {
            businessObjectFormatRestController
                .updateBusinessObjectFormat("I_DO_NOT_EXIST", FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION, request);
            fail("Should throw an ObjectNotFoundException when not able to find business object format.");
        }
        catch (ObjectNotFoundException e)
        {
            assertEquals("Legacy business object definition with name \"I_DO_NOT_EXIST\" doesn't exist.", e.getMessage());
        }
    ...
    public void testGetBusinessObjectFormatLegacy()
    {
        ...
        BusinessObjectFormat resultBusinessObjectFormat =
            businessObjectFormatRestController.getBusinessObjectFormat(BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
    ...
    public void testGetBusinessObjectFormatMissingRequiredParameters()
    {
        ...
        try
        {
            businessObjectFormatRestController.getBusinessObjectFormat(BLANK_TEXT, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
    ...
    public void testGetBusinessObjectFormatMissingOptionalParameters()
    {
        ...
        // Please note that DmDaoTest.testGetBusinessObjectFormatByAltKeyFormatVersionNotSpecified
        // already validates the SQl select logic, so we do not have to go over it here.
        BusinessObjectFormat resultBusinessObjectFormat =
            businessObjectFormatRestController.getBusinessObjectFormat(BLANK_TEXT, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, null);
    ...
    public void testGetBusinessObjectFormatInvalidParameters()
    {
        ...
        // Try to perform a get using invalid business object definition name without passing namespace code.
        try
        {
            businessObjectFormatRestController.getBusinessObjectFormat("I_DO_NOT_EXIST", FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
            fail("Should throw an ObjectNotFoundException when not able to find business object format.");
        }
        catch (ObjectNotFoundException e)
        {
    ...
    public void testGetBusinessObjectFormatsLegacy()
    {
        ...
        BusinessObjectFormatKeys resultKeys = businessObjectFormatRestController.getBusinessObjectFormats(BOD_NAME);
    ...
    public void testGetBusinessObjectFormatsInvalidParameters()
    {
        ...
        // Try to get business object formats using invalid business object definition name without passing namespace code.
        try
        {
            businessObjectFormatRestController.getBusinessObjectFormats("I_DO_NOT_EXIST");
            fail("Should throw an ObjectNotFoundException when not able to find business object format.");
        }
        catch (ObjectNotFoundException e)
        {
    ...
    public void testDeleteBusinessObjectFormatLegacy() throws Exception
    {
        ...
        BusinessObjectFormat deletedBusinessObjectFormat =
            businessObjectFormatRestController.deleteBusinessObjectFormat(BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
    ...
    public void testDeleteBusinessObjectFormatMissingOptionalParameters() throws Exception
    {
        ...
        BusinessObjectFormat deletedBusinessObjectFormat = businessObjectFormatRestController
            .deleteBusinessObjectFormat(BLANK_TEXT, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
    ...
    public void testDeleteBusinessObjectFormatTrimParameters()
    {
        ...
        assertNotNull(dmDao.getBusinessObjectFormatByAltKey(
            new BusinessObjectFormatKey(NAMESPACE_CD, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION)));
    ...
    public void testDeleteBusinessObjectFormatInvalidParameters()
    {
        ...
        // Try to perform a delete using invalid business object definition name and without passing namespace code.
        try
        {
            businessObjectFormatRestController.deleteBusinessObjectFormat("I_DO_NOT_EXIST", FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION);
            fail("Should throw an ObjectNotFoundException when not able to find business object format.");
        }
        catch (ObjectNotFoundException e)
        {
    ...
    public void testDeleteBusinessObjectFormatLatestVersionWhenPreviousVersionExists()
    {
        ...
        // Ensure that this business object format is no longer there.
        latestVersionBusinessObjectFormatEntity = dmDao.getBusinessObjectFormatByAltKey(
        ...
        initialVersionBusinessObjectFormatEntity = dmDao.getBusinessObjectFormatByAltKey(
            new BusinessObjectFormatKey(NAMESPACE_CD, BOD_NAME, FORMAT_USAGE_CODE, FORMAT_FILE_TYPE_CODE, INITIAL_FORMAT_VERSION));
