...
public class DmHelper
{
    ...
    public Date getDateFromString(String dateString) throws IllegalArgumentException
    {
        ...
        if (StringUtils.isNotBlank(dateStringLocal))
        {
            ...
            Assert.isTrue(dateStringLocal.length() == DmDao.DEFAULT_SINGLE_DAY_DATE_MASK.length(), String
                .format("A date value \"%s\" must contain %d characters and be in \"%s\" format.", dateStringLocal, DmDao.DEFAULT_SINGLE_DAY_DATE_MASK.length(),
            ...
            try
            {
                ...
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DmDao.DEFAULT_SINGLE_DAY_DATE_MASK, Locale.US);
            ...
            catch (Exception ex)
            {
                throw new IllegalArgumentException(
                    String.format("A date value \"%s\" must be in \"%s\" format.", dateStringLocal, DmDao.DEFAULT_SINGLE_DAY_DATE_MASK.toUpperCase()), ex);
            }
        }
    ...
    public void validateDownloadedS3Files(String baseDirectory, String s3KeyPrefix, StorageUnit storageUnit) throws IllegalStateException
    {
        ...
        int storageFilesCount = CollectionUtils.isEmpty(storageUnit.getStorageFiles()) ? 0 : storageUnit.getStorageFiles().size();
     ...
     * @throws IllegalArgumentException if any validation errors were found
     */
    public void validateBusinessObjectFormatKey(BusinessObjectFormatKey businessObjectFormatKey, boolean namespaceRequired) throws IllegalArgumentException
    {
        // Validate.
     ...
     * @throws IllegalArgumentException if any validation errors were found
     */
    public void validateBusinessObjectDataKey(BusinessObjectDataKey businessObjectDataKey, boolean namespaceRequired,
        boolean businessObjectFormatVersionRequired, boolean businessObjectDataVersionRequired) throws IllegalArgumentException
    {
     ...
     * @throws IllegalArgumentException if any validation errors were found
     */
    public void validateBusinessObjectDataNotificationRegistrationKey(BusinessObjectDataNotificationRegistrationKey businessObjectDataNotificationKey)
    ...
    public void validateEmrClusterDefinitionConfiguration(EmrClusterDefinition emrClusterDefinition) throws IllegalArgumentException
    {
        ...
        for (String mandatoryTag : dmStringHelper.splitStringWithDefaultDelimiter(configurationHelper.getProperty(ConfigurationValue.MANDATORY_AWS_TAGS)))
        {
