...
public class BusinessObjectDefinitionServiceImpl implements BusinessObjectDefinitionService
{
    ...
    public BusinessObjectDefinition createBusinessObjectDefinition(BusinessObjectDefinitionCreateRequest request)
    {
        ...
        DataProviderEntity dataProviderEntity = dmDaoHelper.getDataProviderEntity(request.getDataProviderName());
        ...
        BusinessObjectDefinitionUpdateRequest request)
    {
        ...
        if (StringUtils.isBlank(businessObjectDefinitionKey.getNamespace()))
        {
            ...
            businessObjectDefinitionEntity = dmDaoHelper.getLegacyBusinessObjectDefinitionEntity(businessObjectDefinitionKey.getBusinessObjectDefinitionName());
        }
        else
        {
            // Since namespace is specified, retrieve a business object definition by it's key.
            businessObjectDefinitionEntity = dmDaoHelper.getBusinessObjectDefinitionEntity(businessObjectDefinitionKey);
        }
    ...
    public BusinessObjectDefinition deleteBusinessObjectDefinition(BusinessObjectDefinitionKey businessObjectDefinitionKey)
    {
        ...
        dmDao.delete(businessObjectDefinitionEntity);
    ...
    public BusinessObjectDefinitionKeys getBusinessObjectDefinitions()
    {
        ...
        businessObjectDefinitionKeys.getBusinessObjectDefinitionKeys().addAll(dmDao.getBusinessObjectDefinitions());
    ...
    public BusinessObjectDefinitionKeys getBusinessObjectDefinitions(String namespaceCode)
    {
        ...
        // Retrieve and return the list of business o
        BusinessObjectDefinitionKeys businessObjectDefinitionKeys = new BusinessObjectDefinitionKeys();
        businessObjectDefinitionKeys.getBusinessObjectDefinitionKeys().addAll(dmDao.getBusinessObjectDefinitions(namespaceCodeLocal));
        return businessObjectDefinitionKeys;
    }
        ...
        BusinessObjectDefinitionUpdateRequest request)
    {
        ...
        // Persist the entity.
        dmDao.saveAndRefresh(businessObjectDefinitionEntity);
    }
