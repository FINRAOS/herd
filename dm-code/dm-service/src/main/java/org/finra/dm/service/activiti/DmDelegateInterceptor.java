...
/**
 * A custom DM Activiti delegate interceptor that allows us to autowire Spring beans onto Java delegate tasks.
 */
@Component
public class DmDelegateInterceptor implements DelegateInterceptor
{
    @Autowired
