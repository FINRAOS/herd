    ...
    public void executeImpl(DelegateExecution execution) throws Exception
    {
        ...
        if(emrCluster.getActiveStep() != null && emrCluster.getActiveStep().getId() != null)
        {
            ...
            if(verboseBoolean)
            {
                ...
                setTaskWorkflowVariable(
                        execution, "activeStep_scriptArguments", dmHelper.buildStringWithDefaultDelimiter(emrCluster.getActiveStep().getScriptArguments()));
        ...
        if(emrCluster.getStep() != null && emrCluster.getStep().getId() != null)
        {
            ...
            if(verboseBoolean)
            {
                ...
                setTaskWorkflowVariable(execution, "step_scriptArguments", dmHelper.buildStringWithDefaultDelimiter(emrCluster.getStep().getScriptArguments()));
