 ...
 * 
 * This class is distinguised from {@link ActivitiHelper} in that it has direct access to a RuntimeService.
 * This class was separated from ActivitiHelper implementation due to a circular dependency introduced if RuntimeService is autowired into ActivitiHelper.
 * The circular dependency is as thus:
 * 
 * RuntimeService -> ProcessEngine -> ProcessEngineConfiguration -> DmCommandInvoker -> ActivitiHelper -> RuntimeService
 * 
 * So instead, this class breaks the circularity:
 * 
 * RuntimeService -> ProcessEngine -> ProcessEngineConfiguration -> DmCommandInvoker -> ActivitiHelper
 * ActivitiRuntimeHelper -> RuntimeService
 * 
