...
/**
 * A custom DM Activiti command invoker that extends the default standard Activiti command invoker so we can handle exceptions being thrown in a custom way.
 */
@Component
public class DmCommandInvoker extends CommandInvoker
{
