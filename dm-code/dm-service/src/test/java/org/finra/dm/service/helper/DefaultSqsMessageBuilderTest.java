...
public class DefaultSqsMessageBuilderTest extends AbstractServiceTest
{
    ...
    public void testBuildBusinessObjectDataStatusChangeMessage()
    {
        ...
        testBuildBusinessObjectDataStatusChangeMessage(subPartitionValues, DmDaoSecurityHelper.SYSTEM_USER);
    }
    ...
    public void testBuildSystemMonitorResponseInvalidVelocityTemplate() throws Exception
    {
        ...
        Map<String, Object> overrideMap = new HashMap<>();
        overrideMap.put(ConfigurationValue.DM_NOTIFICATION_SQS_SYS_MONITOR_RESPONSE_VELOCITY_TEMPLATE.getKey(), "#if($missingEndOfIfStatement");
        modifyPropertySourceInEnvironment(overrideMap);
    ...
    public void testBuildSystemMonitorResponseNoXPathExpressions() throws Exception
    {
        ...
        Map<String, Object> overrideMap = new HashMap<>();
        overrideMap.put(ConfigurationValue.DM_NOTIFICATION_SQS_SYS_MONITOR_REQUEST_XPATH_PROPERTIES.getKey(), null);
        modifyPropertySourceInEnvironment(overrideMap);
    ...
    public void testBuildSystemMonitorResponseInvalidXpathExpression() throws Exception
    {
        ...
        Map<String, Object> overrideMap = new HashMap<>();
        overrideMap.put(ConfigurationValue.DM_NOTIFICATION_SQS_SYS_MONITOR_REQUEST_XPATH_PROPERTIES.getKey(), "key=///");
        modifyPropertySourceInEnvironment(overrideMap);
    ...
    public void testBuildSystemMonitorResponseInvalidXpathProperties() throws Exception
    {
        ...
        Map<String, Object> overrideMap = new HashMap<>();
        overrideMap.put(ConfigurationValue.DM_NOTIFICATION_SQS_SYS_MONITOR_REQUEST_XPATH_PROPERTIES.getKey(), "key=\\uxxxx");
        modifyPropertySourceInEnvironment(overrideMap);
