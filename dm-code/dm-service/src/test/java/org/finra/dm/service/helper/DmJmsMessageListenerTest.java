...
/**
 * This class tests functionality within the DmJmsMessageListener.
 */
public class DmJmsMessageListenerTest extends AbstractServiceTest
{
    @Autowired
    DmJmsMessageListener dmJmsMessageListener;
    ...
    {
        dmJmsMessageListener.processMessage(getTestSystemMonitorIncomingMessage(), null);
    }
    ...
    public void testS3Message() throws Exception
    {
        ...
        Logger.getLogger(DmJmsMessageListener.class).setLevel(Level.OFF);

        dmJmsMessageListener.processMessage(jsonHelper.objectToJson(s3EventNotification), null);
    }
    ...
    public void testS3MessageWrongMessage() throws Exception
    {
        ...
        dmJmsMessageListener.processMessage("WRONG_MESSAGE", null);
    }
}