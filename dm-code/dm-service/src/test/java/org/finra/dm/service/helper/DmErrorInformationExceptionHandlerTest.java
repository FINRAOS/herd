...
/**
 * Test the DM Rest Controller Advice.
 */
public class DmErrorInformationExceptionHandlerTest extends AbstractServiceTest
{
    @Autowired
    ...
    {
        validatePersistenceException(DmErrorInformationExceptionHandler.ORACLE_SQL_STATE_CODE_ERROR,
                DmErrorInformationExceptionHandler.ORACLE_DATA_TOO_LARGE_ERROR_CODE);

        validatePersistenceException(DmErrorInformationExceptionHandler.ORACLE_SQL_STATE_CODE_ERROR,
                DmErrorInformationExceptionHandler.ORACLE_LONG_DATA_IN_LONG_COLUMN_ERROR_CODE);

        validatePersistenceException(DmErrorInformationExceptionHandler.POSTGRES_SQL_STATE_CODE_TRUNCATION_ERROR, 0);
    }
    ...
    public void testConstraintViolationException() throws Exception
    {
        ...
        validateErrorInformation(exceptionHandler.handlePersistenceException(getPersistenceException(new SQLException(MESSAGE,
                DmErrorInformationExceptionHandler.POSTGRES_SQL_STATE_CODE_FOREIGN_KEY_VIOLATION, 0)), new MockHttpServletResponse()), HttpStatus.BAD_REQUEST,
                false);
    }
