 ...
 *
 */
public class RegisterBusinessObjectDataTest extends DmActivitiServiceTaskTest
{
    @Test
    ...
    public void testRegisterBusinessObjectDataWrongXmlRequest() throws Exception
    {
        ...
        Map<String, Object> variableValuesToValidate = new HashMap<>();
        variableValuesToValidate.put(ActivitiHelper.VARIABLE_ERROR_MESSAGE, "\"BusinessObjectDataCreateRequest\" must be valid xml string.");
    ...
    public void testRegisterBusinessObjectDataWrongJsonRequest() throws Exception
    {
        ...
        Map<String, Object> variableValuesToValidate = new HashMap<>();
        variableValuesToValidate.put(ActivitiHelper.VARIABLE_ERROR_MESSAGE, "\"BusinessObjectDataCreateRequest\" must be valid json string.");
