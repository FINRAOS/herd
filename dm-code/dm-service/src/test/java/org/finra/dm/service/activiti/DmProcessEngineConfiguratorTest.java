...
/**
 * Tests the DmProcessEngineConfigurator class.
 *
 */
public class DmProcessEngineConfiguratorTest extends AbstractServiceTest
{
    @Autowired
    DmProcessEngineConfigurator dmProcessEngineConfigurator;
    ...
    public void testNoStringAndLongStringType() throws Exception
    {
        ...
        dmProcessEngineConfigurator.configure(configuration);
