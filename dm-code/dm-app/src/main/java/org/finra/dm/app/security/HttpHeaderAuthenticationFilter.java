...
public class HttpHeaderAuthenticationFilter extends GenericFilterBean
{
     ...
     * @throws ServletException if a servlet exception was encountered.
     */
    public void doHttpFilter(HttpServletRequest servletRequest, HttpServletResponse servletResponse, FilterChain filterChain) throws IOException,
        ServletException
    {
    ...
    /**
     * Creates the user based on the given request, and puts the user into the security context.
    ...
    private void authenticateUser(HttpServletRequest servletRequest)
    {
        try
        {
            ...
            PreAuthenticatedAuthenticationToken preAuthenticatedAuthenticationToken = new PreAuthenticatedAuthenticationToken(applicationUserBuilder.build(
                servletRequest), "N/A");
    ...
    /**
     * <p>
     * Returns {@code true} if the given user is different than the user in the current session, {@code false} if equal.
     * </p>
     * <p>
     * The users are considered different if:
     * </p>
     * <ul>
     * <li>The user is null, or</li>
     * <li>The user id is different, or</li>
     * <li>The session init time is different</li>
     * </ul>
     * 
    ...
    private boolean isUserDifferentThanLoggedInUser(ApplicationUser user)
    {
        ...
        return !ObjectUtils.equals(userId, getExistingUserId()) || !ObjectUtils.equals(sessionInitTime, getExistingSessionInitTime());
    }
