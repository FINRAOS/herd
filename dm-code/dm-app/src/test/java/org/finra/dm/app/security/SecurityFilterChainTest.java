...
/**
 * Tests cases where the {@link TrustedUserAuthenticationFilter} and {@link HttpHeaderAuthenticationFilter} are used in sequence.
 */
public class SecurityFilterChainTest extends AbstractAppTest
{
     ...
     * <li>principal type is {@link SecurityUserWrapper}</li>
    ...
    /**
     * Executes {@link TrustedUserAuthenticationFilter} and {@link HttpHeaderAuthenticationFilter} in sequence with security enabled or disabled, with the given
