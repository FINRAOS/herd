...
/**
 * Test for {@link SecurityManagerHelper}.
...
{
    /**
     * When {@link SecurityManagerHelper#doPrivileged(PrivilegedAction)} is called which executes an action restricted by security manager, the method should
