...
SwaggerUi.Views.OperationView = Backbone.View.extend({
  ...
  formatXml: function(xml) {
    ...
    //TODO: Added check for non-string (i.e. !xml.replace) to handle other objects being passed in here. Need to figure out what those objects are and why
    //they are being passed in.
    if (!xml || !xml.replace){
      return xml;
    }
    reg = /(>)(<)(\/*)/g;
