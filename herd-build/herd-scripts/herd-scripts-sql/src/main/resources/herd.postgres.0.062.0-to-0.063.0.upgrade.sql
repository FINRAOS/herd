...
values ('FN_RELATIONAL_TABLE_REGISTRATIONS_POST', current_timestamp, 'SYSTEM', current_timestamp, 'SYSTEM');

--strge_pltfm

insert into strge_pltfm (strge_pltfm_cd, creat_ts, creat_user_id, updt_ts, updt_user_id) 
values ('RELATIONAL', current_timestamp, 'SYSTEM', current_timestamp, 'SYSTEM');

--file_type_cd_lk

insert into file_type_cd_lk (file_type_cd, file_type_ds, creat_ts, creat_user_id, updt_ts, updt_user_id)
values ('RELATIONAL_TABLE', 'RELATIONAL_TABLE', current_timestamp, 'SYSTEM', current_timestamp, 'SYSTEM');
